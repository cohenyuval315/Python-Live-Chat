from db_models import Permission,Role,User,Channel,ChatMessage
...
class Seed():
    ...
    def _init_channels(self):
        ...
        user_channel = Channel(id=self._generate_id(),name="user_only",role_id=self.user_role_id,color=ColorType.PINK)
    ...
    def _encrypt_pass(self,password):
        return bcrypt.hashpw(password.encode("utf-8"), bcrypt.gensalt(16)).decode()
