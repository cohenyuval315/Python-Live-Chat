...
from prompt_python_chat.constants import Constants
from .manager_base import ManagerBase
from prompt_python_chat.client.apis.chat_api import ChatAPI
...
class ChatManager(ManagerBase):
    def __init__(self, channel_window: ChannelWindow,chat_api:ChatAPI) -> None:
        ...
        self.current_channel_name = Constants.LOBBY.value
    ...
    def init_lobby(self):
        ...
        self.channel_window.add_line(Constants.LOBBY_MSG.value)
    ...
    async def change_channel(self,channel_name: str,token):
        ...
        if channel_name == Constants.LOBBY.value:
    ...
    async def exit_channel(self,token):
        if self.current_channel_name == Constants.LOBBY.value:
